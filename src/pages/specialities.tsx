    ...
    <div className="   flex flex-col w-full min-h-screen bg-stone-900 font-tajawal">
      <div className="w-full overflow-hidden flex py-4 h-40 px-4 text-center space-y-2">
        <div className="self-end flex-1 text-left">
          ...
          <h2 className="text-3xl text-white font-bold">12 point!</h2>
      ...
      <div className="flex-1  py-4 px-4  bg-slate-100 rounded-t-3xl">
        <div>
          ...
          <div className="mt-2 -mx-4 h-36 flex snap-x overflow-x-auto space-x-8">
            <div className="snap-start p-6 pb-8 flex flex-col justify-between scroll-ml-6 flex-shrink-0 w-32 h-full rounded-xl bg-pink-100">
              <img src="../art.png" className="w-12 h-12" />
              <div className="flex-1 space-y-1">
                <p className="text-md">scientific</p>
                <h2 className="text-lg font-bold leading-3">Medcine</h2>
                <p className="text-sm">15 - 18</p>
              </div>
            </div>
            <div className="snap-start p-6 pb-8 flex flex-col justify-between scroll-ml-6 flex-shrink-0 w-32 h-full rounded-xl bg-blue-100">
              <img src="../art.png" className="w-12 h-12" />
              <div className="flex-1 space-y-1">
                <p className="text-md">scientific</p>
                <h2 className="text-lg font-bold leading-3">Medcine</h2>
            ...
            <div className="snap-start p-6 pb-8 flex flex-col justify-between scroll-ml-6 flex-shrink-0 w-32 h-full rounded-xl bg-yellow-100">
              <img src="../art.png" className="w-12 h-12" />
              <div className="flex-1 space-y-1">
                <p className="text-md">scientific</p>
                <h2 className="text-lg font-bold leading-3">Medcine</h2>
        ...
        <div className="sticky bg-slate-100 [@supports(backdrop-filter:blur(0))]:bg-slate-100/25  backdrop-blur-sm top-0 mt-2 py-2">
          ...
          <div className="-mx-4 mt-1 py-1 flex snap-x overflow-x-auto space-x-4">
            ...
            <div className="shadow-sm bg-white rounded-full px-4 py-1 text-sm font-semibold">
              scientific
            </div>
            <div className="shadow-sm bg-white rounded-full px-4 py-1 text-sm font-semibold">
              informatique
